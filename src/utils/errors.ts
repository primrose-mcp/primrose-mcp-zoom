 ...
 *
 * Custom error classes and error handling helpers for Zoom API.
 */
 ...
 */
export class RateLimitError extends ZoomApiError {
 ...
 */
export class AuthenticationError extends ZoomApiError {
 ...
 * Not found error
 */
export class NotFoundError extends ZoomApiError {
 ...
 * Validation error
 */
export class ValidationError extends ZoomApiError {
